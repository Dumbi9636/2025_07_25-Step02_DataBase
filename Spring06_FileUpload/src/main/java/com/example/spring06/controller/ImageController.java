...
public class ImageController {
	...
	public ResponseEntity<InputStreamResource> image(@PathVariable("saveFileName") String name) throws IOException{
		 ...
		 *  
		 *  @PathVariable 어노테이션 
		 *  즉 경로 변수, <img src="/Spring06/upload/cf50fd42-3a4d-4f0b-90db-45452e6d2de4UK.png" /> 와 같이 
		 *  /upload/ 뒤에 오는 cf50fd42-3a4d-4f0b-90db-45452e6d2de4UK 이다. 
		 *  
		 */
