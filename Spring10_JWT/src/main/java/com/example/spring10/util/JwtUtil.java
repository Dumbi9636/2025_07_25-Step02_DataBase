...
/*
 *  JwtUtil 클래스가 동작하기 위해서 pom.xml 에 아래의 dependency 를 추가해야한다
...
public class JwtUtil {
	 ...
	 *  jwt.secret 이라는 키값으로 토큰을 발급할때 서명할 key 를 설정했는데 그 문자열을 읽어와야한다 
	 */
    @Value("${jwt.secret}")
    private String secretKey;
    
    // jwt.expiration 이라는 키값으로 토큰의 유효기간을 설정했는데 해당 숫자를 읽어와서 사용한다 
    ...
    /*
     * userName 과 추가정보(claims)를 매개변수로 전달하면 해당 정보를 token 에 저장하고 
