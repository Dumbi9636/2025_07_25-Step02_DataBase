 ...
 *	- /upload/xxx.png, /upload/xxx.jpg 형식의 요청을 이 서블릿에서 처리한다. 
 *	- img 요소에 특정 이미지를 보여주려면 <img src ="컨텍스트경로/upload/저장된파일명"> 형식으로 코딩하면 된다 
 */
@WebServlet("/upload/*")
public class ImageServlet extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // 맨앞에 슬래시 / 를 제거하는 작업 
        String imageName = pathInfo.substring(1); // 예: "xxx.jpg"
